                ...
                <table id="datatable1" class="table user-table no-wrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $row->stock }}</td>
                            <td>
                                <button class="button-status btn btn-sm btn-{{ $row->status ? 'success' : 'danger' }} btn-sm btn-flat mr-2" data-id="{{ $row->id }}" style="color: white">
                                    {{ $row->status ? 'Active' : 'Nonactive' }}
                                </button>
                            </td>
                            <td>
                                <a href="{{ route('product.edit', ['product' => $row->id]) }}" class="btn btn-warning btn-sm btn-flat mr-2"><i class="fas fa-pencil-alt"></i>
                                    Edit</a>
...
<script type="text/javascript">
    ...
    $('.button-status').click(function() {
        ...
        form.attr('action', "{{ url('/admin/product/status') }}/" + id);
