            ...
            <div class="card-body">
                <form class="form-horizontal form-material mx-2" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" id="full_name" name="full_name" value="{{ $product->full_name }}" required
                                placeholder="Nama Lengkap" class="form-control ps-0 form-control-line">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12 mb-0">Alamat Produk</label>
                        <div class="col-md-12">
                            <input type="text" id="nim" name="nim" value="{{ $product->nim }}" required
                                placeholder="110009xx" class="form-control ps-0 form-control-line">
                        </div>
                    </div>
                    <div class="form-group">
