...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            <form class="form-horizontal form-material mx-2" method="post" action="{{ route('product.update', ['product' => $product->id]) }}" enctype="multipart/form-data">
                @method('put')
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <textarea name="description" id="description" cols="30" rows="10" class="form-control" value="......" required>{{ $product->description }}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-12 mb-0">No WhatsApp</label>
                    <div class="col-md-12">
                        <input type="number" id="whatsapp" name="whatsapp" required placeholder="0857xxx" value="{{ $product->whatsapp }}" class="form-control ps-0 form-control-line">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-12 mb-0">Stok Barang</label>
                    <div class="col-md-12">
                        <input type="number" id="stock" name="stock" required placeholder="0" value="{{ $product->stock }}" class="form-control ps-0 form-control-line">
                    </div>
                </div>
                    ...
                    <div class="row form-image-{{ $index }}">
                        <div class="col-sm-6">
                            <div class="form-group mt-3">
                                <div class="col-md-12">
                                    <input type="file" id="image" onchange="preview({{ $index }})" name="image[]" class="form-control ps-0 form-control-line">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="btn-group">
                                <a href="{{ asset('products/' . $item->image) }}" class="btn btn-info mt-3 lihat-gambar-{{ $index }}" target="_blank"><i class="fas fa-eye"></i>&nbsp;Lihat
                                    Gambar</a>
                                &nbsp;
