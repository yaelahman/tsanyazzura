...
@section('content')
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <form class="form-horizontal form-material mx-2" method="post" action="{{ route('tim.store') }}"
                    ...
                    <div class="row">
                        <div class="col-sm-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control" placeholder="1"
                                    required>
                            </div>
                        </div>
                        <div class="col-sm-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="jabatan" id="jabatan" class="form-control" placeholder="1"
                                    required>
                            </div>
                        </div>
                        <div class="col-sm-6 mt-3">
                    ...
                    <div class="form-group mt-3">
                        <div class="col-sm-12 d-flex">
                            <button class="btn btn-success mx-auto mx-md-0 text-white">Save Tim</button>
                        </div>
                    </div>
                </form>
            </div>
