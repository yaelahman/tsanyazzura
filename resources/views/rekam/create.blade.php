...
@section('content')
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <form class="form-horizontal form-material mx-2" method="post" action="{{ route('rekam.store') }}">
                    @csrf
                    <div class="form-group">
                        <label class="col-md-12 mb-0">Text</label>
                        <div class="col-md-12">
                            <input type="text" id="name" name="text" required placeholder="Text"
                                class="form-control ps-0 form-control-line">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12 d-flex">
                            <button class="btn btn-success mx-auto mx-md-0 text-white">Save Rekam Jejak</button>
                        </div>
                    </div>
                </form>
            </div>
