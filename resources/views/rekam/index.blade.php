...
@section('content')
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 col-4 align-self-center">
                <div class="text-end upgrade-btn">
                    <a href="{{ route('rekam.create') }}" class="btn btn-success d-none d-md-inline-block text-white">
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3">Data Rekam</h4>
                <div class="table-responsive">
                    <table id="datatable1" class="table user-table no-wrap">
                        ...
                        <tbody>
                            @foreach ($rekam as $index => $row)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $row->text }}</td>
                                    <td>
                                        <a href="{{ route('rekam.edit', ['rekam' => $row->id]) }}"
...
@section('script')
    <script type="text/javascript">
        $('.button-delete').click(function() {
            ...
            form.attr('action', "{{ url('/admin/rekam') }}/" + id);
