    ...
    <div class="container my-5 px-5">
        ...
        <form action="{{ route('landing.dukung_sakti.store') }}" method="POST">
            ...
            <div class="form-floating mb-3">
                ...
                <label for="floatingInput">Nomor WhatsApp <small class="text-danger">(Wajib)</small></label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" name="nama" class="form-control" required id="floatingInput" placeholder="">
                <label for="floatingInput">Nama Lengkap (sesuai KTP) <small class="text-danger">(Wajib)</small></label>
            </div>
            <div class="form-floating mb-3">
                ...
                <label for="floatingSelect">Jenis Kelamin <small class="text-danger">(Wajib)</small></label>
            </div>

            <div class="form-floating mb-3">
                <input type="date" name="tanggal_lahir" required class="form-control" id="floatingInput" placeholder="">
                <label for="floatingInput">Tanggal Lahir <small class="text-danger">(Wajib)</small></label>
            </div>
            ...
            <div class="form-floating mb-3">
                ...
                <label for="floatingSelect">Keluarahan <small class="text-danger">(Wajib)</small></label>
            </div>
