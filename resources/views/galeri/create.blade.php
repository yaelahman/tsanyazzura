...
@section('content')
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 col-4 align-self-center">
                <div class="text-end upgrade-btn">
                    <a href="{{ route('galeri.index') }}" class="btn btn-success d-none d-md-inline-block text-white">
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <form class="form-horizontal form-material mx-2" method="post" action="{{ route('galeri.store') }}"
                    ...
                    <div class="row">
                        <div class="col-sm-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" class="form-control" placeholder="1"
                                    required>
                            </div>
                        </div>
                        <div class="col-sm-6 mt-3">
                    ...
                    <div class="form-group mt-3">
                        <div class="col-sm-12 d-flex">
                            <button class="btn btn-success mx-auto mx-md-0 text-white">Save Galeri</button>
                        </div>
                    </div>
                </form>
            </div>
