                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 mt-3">
                        <div class="form-group mt-3">
                            <div class="col-md-12">
                                <input type="file" id="image-{{$index}}" onchange="preview({{$index}})" name="image_{{$index}}" class="form-control ps-0 form-control-line">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 mt-3">
                        <div class="btn-group">
                            <a href="{{ asset('galeri/' . $item->text) }}" class="btn btn-info mt-3 lihat-gambar-{{$index}}" target="_blank"><i class="fas fa-eye"></i>&nbsp;Lihat
                                Gambar</a>
                            &nbsp;
                        </div>
                    </div>
